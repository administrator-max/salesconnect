...
// ── Data-driven dropdowns (admin-managed via api/config) ──────────────────────
// Falls back to these defaults if the config API is unavailable (e.g. before unlock).
// NOTE: shipment_types/margin_types/commission_units values are bound to the pricing
// calc — labels are free to edit, values are not.
let CC_CFG = {
  shipment_types:   [{value:"breakbulk",label:"Break Bulk"},{value:"container20",label:"Container 20ft"},{value:"container40",label:"Container 40ft"}],
  hedging_days:     [{value:"60"},{value:"90"},{value:"150"}],
  margin_types:     [{value:"fixed",label:"Fixed (IDR/kg)"},{value:"percent",label:"Percentage (%)"}],
  commission_units: [{value:"idr",label:"IDR/kg"},{value:"usd",label:"USD/MT"}],
};
...
function openCostcoreSettings(){
  ConfigAdmin.open({basePath:"api",title:"Cost Core Settings",
    lookups:[
      {key:"payment_terms",   title:"Payment Terms",   fields:[]},
      {key:"hedging_days",    title:"Hedging Days",    fields:[]},
